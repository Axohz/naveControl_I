...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_GALAXIA = 5,                    /* GALAXIA  */
  YYSYMBOL_ABASTECER = 6,                  /* ABASTECER  */
  YYSYMBOL_ARISTA = 7,                     /* ARISTA  */
  YYSYMBOL_ACTUALIZAR_ARISTA = 8,          /* ACTUALIZAR_ARISTA  */
  YYSYMBOL_NAVE = 9,                       /* NAVE  */
  YYSYMBOL_VIAJE_AUTO = 10,                /* VIAJE_AUTO  */
  YYSYMBOL_DESTINO = 11,                   /* DESTINO  */
  YYSYMBOL_MODO = 12,                      /* MODO  */
  YYSYMBOL_MIN_COMBUSTIBLE = 13,           /* MIN_COMBUSTIBLE  */
  YYSYMBOL_MIN_SALTOS = 14,                /* MIN_SALTOS  */
  YYSYMBOL_PASOS = 15,                     /* PASOS  */
  YYSYMBOL_VIAJE_MANUAL = 16,              /* VIAJE_MANUAL  */
  YYSYMBOL_VER_VECINAS = 17,               /* VER_VECINAS  */
  YYSYMBOL_RADIO = 18,                     /* RADIO  */
  YYSYMBOL_HACIA = 19,                     /* HACIA  */
  YYSYMBOL_RECARGAR = 20,                  /* RECARGAR  */
  YYSYMBOL_SALIR = 21,                     /* SALIR  */
  YYSYMBOL_YYACCEPT = 22,                  /* $accept  */
  YYSYMBOL_entrada = 23,                   /* entrada  */
  YYSYMBOL_linea = 24,                     /* linea  */
  YYSYMBOL_def_galaxia = 25,               /* def_galaxia  */
  YYSYMBOL_def_arista = 26,                /* def_arista  */
  YYSYMBOL_upd_arista = 27,                /* upd_arista  */
  YYSYMBOL_crear_nav = 28,                 /* crear_nav  */
  YYSYMBOL_cmd_viaje_auto = 29,            /* cmd_viaje_auto  */
  YYSYMBOL_modo_opt = 30,                  /* modo_opt  */
  YYSYMBOL_pasos_opt = 31,                 /* pasos_opt  */
  YYSYMBOL_cmd_viaje_manual = 32,          /* cmd_viaje_manual  */
  YYSYMBOL_cmd_recarga = 33,               /* cmd_recarga  */
  YYSYMBOL_cmd_salir = 34                  /* cmd_salir  */
};
...
{
       0,   379,   379,   381,   385,   386,   387,   388,   389,   390,
     391,   392,   393,   397,   398,   402,   406,   410,   414,   422,
     423,   427,   428,   432,   433,   437,   441
};
#endif
...
static const char *const yytname[] =
{
  ...
  "NUMERO", "GALAXIA", "ABASTECER", "ARISTA", "ACTUALIZAR_ARISTA", "NAVE",
  "VIAJE_AUTO", "DESTINO", "MODO", "MIN_COMBUSTIBLE", "MIN_SALTOS",
  "PASOS", "VIAJE_MANUAL", "VER_VECINAS", "RADIO", "HACIA", "RECARGAR",
  "SALIR", "$accept", "entrada", "linea", "def_galaxia", "def_arista",
  "upd_arista", "crear_nav", "cmd_viaje_auto", "modo_opt", "pasos_opt",
  "cmd_viaje_manual", "cmd_recarga", "cmd_salir", YY_NULLPTR
};
...
{
     -16,     0,   -16,   -16,     3,    10,    11,    12,    -8,   -15,
     -16,   -16,   -16,   -16,   -16,   -16,   -16,   -16,   -16,   -16,
     -16,    13,    14,    15,    18,    20,     6,    22,   -16,    23,
      24,   -16,    17,    26,   -16,   -16,   -16,    -2,    16,   -16,
     -16,   -16,    28,   -16,   -16
};
...
static const yytype_int8 yydefact[] =
{
      ...
      11,    13,     0,     0,     0,     0,     0,     0,    14,     0,
       0,    17,     0,     0,    24,    15,    16,     0,    22,    23,
      19,    20,     0,    18,    21
};
...
{
       2,     3,    26,    25,    27,     4,    21,     5,     6,     7,
       8,    40,    41,    22,    23,    24,     9,    29,    30,    28,
      10,    11,    31,    32,    33,    34,     0,    35,    36,    37,
      39,    42,    44
};

static const yytype_int8 yycheck[] =
{
       0,     1,    17,    11,    19,     5,     3,     7,     8,     9,
      10,    13,    14,     3,     3,     3,    16,     3,     3,     6,
      20,    21,     4,     3,    18,     3,    -1,     4,     4,    12,
       4,    15,     4
};
...
{
       0,    23,     0,     1,     5,     7,     8,     9,    10,    16,
      20,    21,    24,    25,    26,    27,    28,    29,    32,    33,
      34,     3,     3,     3,     3,    11,    17,    19,     6,     3,
       3,     4,     3,    18,     3,     4,     4,    12,    30,     4,
      13,    14,    15,    31,     4
};
...
#line 1456 "parser.tab.c"
  ...
  case 13: /* def_galaxia: GALAXIA IDENTIFICADOR  */
#line 397 "parser.y"
                          { addGalaxy((yyvsp[0].strval),0); }
#line 1462 "parser.tab.c"
    break;

  case 14: /* def_galaxia: GALAXIA IDENTIFICADOR ABASTECER  */
#line 398 "parser.y"
                                      { addGalaxy((yyvsp[-1].strval),1); }
#line 1468 "parser.tab.c"
    break;

  case 15: /* def_arista: ARISTA IDENTIFICADOR IDENTIFICADOR NUMERO  */
#line 402 "parser.y"
                                              { addEdge((yyvsp[-2].strval),(yyvsp[-1].strval),(yyvsp[0].intval)); }
#line 1474 "parser.tab.c"
    break;

  case 16: /* upd_arista: ACTUALIZAR_ARISTA IDENTIFICADOR IDENTIFICADOR NUMERO  */
#line 406 "parser.y"
                                                         { updateEdge((yyvsp[-2].strval),(yyvsp[-1].strval),(yyvsp[0].intval)); }
#line 1480 "parser.tab.c"
    break;

  case 17: /* crear_nav: NAVE IDENTIFICADOR NUMERO  */
#line 410 "parser.y"
                              { crearNave((yyvsp[-1].strval),(yyvsp[0].intval)); }
#line 1486 "parser.tab.c"
    break;

  case 18: /* cmd_viaje_auto: VIAJE_AUTO DESTINO IDENTIFICADOR modo_opt pasos_opt  */
#line 414 "parser.y"
                                                        {
        int m = ((yyvsp[-1].intval) == 1) ? 1 : 2;
        printf("Comando VIAJE_AUTO: Destino=%s, Modo=%d, Pasos=%d\n", (yyvsp[-2].strval), m, (yyvsp[0].intval));
        viajarAutonomo((yyvsp[-2].strval), m, (yyvsp[0].intval));
    }
#line 1496 "parser.tab.c"
    break;

  case 19: /* modo_opt: MODO MIN_COMBUSTIBLE  */
#line 422 "parser.y"
                         { (yyval.intval)=1; }
#line 1502 "parser.tab.c"
    break;

  case 20: /* modo_opt: MODO MIN_SALTOS  */
#line 423 "parser.y"
                      { (yyval.intval)=2; }
#line 1508 "parser.tab.c"
    break;

  case 21: /* pasos_opt: PASOS NUMERO  */
#line 427 "parser.y"
                 { (yyval.intval)=(yyvsp[0].intval); }
#line 1514 "parser.tab.c"
    break;

  case 22: /* pasos_opt: %empty  */
#line 428 "parser.y"
                   { (yyval.intval)=1; }
#line 1520 "parser.tab.c"
    break;

  case 23: /* cmd_viaje_manual: VIAJE_MANUAL VER_VECINAS RADIO NUMERO  */
#line 432 "parser.y"
                                          { verVecinas((yyvsp[0].intval)); }
#line 1526 "parser.tab.c"
    break;

  case 24: /* cmd_viaje_manual: VIAJE_MANUAL HACIA IDENTIFICADOR  */
#line 433 "parser.y"
                                       { viajeManualHacia((yyvsp[0].strval)); }
#line 1532 "parser.tab.c"
    break;

  case 25: /* cmd_recarga: RECARGAR  */
#line 437 "parser.y"
             { recargarCombustible(); }
#line 1538 "parser.tab.c"
    break;

  case 26: /* cmd_salir: SALIR  */
#line 441 "parser.y"
